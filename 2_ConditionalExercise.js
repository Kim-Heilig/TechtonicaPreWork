...
console.log("Exercise 1:  " + exercise1(12));
// EXERCISE 2.
...
console.log("Exercise 2:  " + exercise2(6.3));
// EXERCISE 3.
...
console.log("Exercise 3:  " + exercise3(9));
...
function exercise4(varA, varB) {
  ...
  // Write your code for the exercise below here:
  // --------------------------------------------
    if((typeof varA === "string" || typeof varA === "number" ) && (typeof varB === "string" || typeof varB === "number" ) && (varA === varB)){
...
console.log("Exercise 4:  " + exercise4(9, 9));


// EXERCISE 5.
// In exercise 4, what are some of the unexpected cases where `varA` and `varB`
// seemed like they are equal, but would not pass the tests? They might seem like equals if one is a string that converts to a number (such as "4" might be equal to 4). In your analysis
// consider other data types beside strings and variables.  I believe using the strict equality operator takes care of any unforeseen potential problems.
...
console.log("Exercise 6:  " + exercise6(9, 5, 5));
...
console.log("Exercise 7:  " + exercise7(1));
console.log("Exercise 7:  " + exercise7(7));
console.log("Exercise 7:  " + exercise7(101));
console.log("Exercise 7:  " + exercise7(1000000));
console.log("Exercise 7:  " + exercise7(13));
...
console.log("Exercise 8:  " + exercise8(5, 6, 1, 10));
console.log("Exercise 8:  " + exercise8(1, 6, 1, 10));
console.log("Exercise 8:  " + exercise8(5, 6, 1, 4));
console.log("Exercise 8:  " + exercise8(5, 8, 1, 10));
...
console.log("Exercise 9:  " + exercise9(true));
console.log("Exercise 9:  " + exercise9(8));
console.log("Exercise 9:  " + exercise9(7));
...
console.log("Exercise 10:  " + exercise10(30));
console.log("Exercise 10:  " + exercise10(1));
console.log("Exercise 10:  " + exercise10(3));
console.log("Exercise 10:  " + exercise10(20));
...
//I found it to be just perfect practice for me, possibly easy only because much of the 
//other work was a lot more complicated.  This took time and the answers weren't readily
// easy for me, but it took little effort to find the right syntax, little effort to put 
//it together and I feel I a walking away with the material fairly under control in a confident way.  
//Having said that, it did take time and concentration to complete. I used ChatGPT several times, along with 
//W3Schools.  When I use ChatGPT I am careful to ask it targeted questions (like please provide an example
// of how to use switch cases in javascript instead of asking for the complete answer).
